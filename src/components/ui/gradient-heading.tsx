...
const headingVariants = cva(
  "tracking-tight pb-3 bg-clip-text text-transparent",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-t from-foreground/70 to-foreground",
        pink: "bg-gradient-to-t from-accent to-accent/90",
        light: "bg-gradient-to-t from-muted-foreground/60 to-muted-foreground/80",
        secondary: "bg-gradient-to-t from-muted-foreground to-muted-foreground/90",
      },
      size: {
