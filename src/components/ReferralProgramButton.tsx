  ...
  return (
    <Link to="/register" onClick={onClick} className={cn("inline-flex", className)}>
      ...
      >
        ...
        <span
          aria-hidden
          className="absolute -left-1/3 top-0 h-full w-1/3 -skew-x-12 rounded-full bg-gradient-to-r from-transparent via-white/85 to-transparent opacity-0 blur-[1px] group-hover:opacity-100 group-hover:animate-[shimmer_1.7s_ease-in-out_infinite]"
        />
        <span
          className={cn(
            "relative inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-[linear-gradient(135deg,rgba(35,17,68,0.98),rgba(55,25,96,0.95)_45%,rgba(28,20,65,0.98))] font-semibold text-white ring-1 ring-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.15),0_10px_30px_rgba(139,92,246,0.28)] transition-transform duration-300",
